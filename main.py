...
6. 消耗品管理
   - 【住人向け】消耗品を購入した際の報告機能（何を・いくらで買ったか）
   - 【住人向け】消耗品がなくなった際の通知機能（トイレットペーパー、洗剤等）
   - 【管理者向け】消耗品の消費ペース分析（物件・品目ごとの消費速度、補充タイミング予測）
   - 【管理者向け】電気代分析（物件ごとの電気代推移、前年比、住人数あたりのコスト）

7. ドミトリー（多人数部屋）対応
   - 1つの部屋に複数人が入居できるドミトリータイプの部屋管理
   - ドミトリー部屋のベッド数・定員設定
   - ドミトリー部屋ごとの個別家賃設定（住人ごとに異なる家賃）
   - ドミトリーの空きベッド数に基づく稼働率計算
